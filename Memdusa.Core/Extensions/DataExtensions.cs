...
namespace Memdusa.Core.Extensions;
...
public static class DataExtensions
{
    ...
    public static string ToHexString(this ReadOnlyMemory<byte> ba)
    {
        return ToHexString(ba.ToArray());
    }
    ...
    public static string ToHexDump(this ReadOnlyMemory<byte> bytes, int bytesPerLine = 16)
    {
        return ToHexDump(bytes.Span, bytesPerLine);
    }
